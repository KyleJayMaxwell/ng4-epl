    ...
    private getMockEnglishLeague(): TeamInfo[] {
      return [
          ...
          { id: 5,
            ...
            city: 'Liverpool',
            leagueTitles: 9,
            description: `Everton Football Club (/ˈɛvərtən/) is a football club in Liverpool, England, that competes in the Premier League, the top flight of English football. The club have competed in the top division for a record 114 seasons, missing the top division only four times (1930–31 and three consecutive seasons starting with 1951–52) since The Football League was created in 1888. Everton has won the League Championship nine times (fourth most as of 2016–17), and the FA Cup five times (ninth most).
